    ...
    plop.setGenerator('placeholders', {
        ...
        actions: [
            function customAction(answers) {
                ...
                let templateFile = path.resolve(`${extension}/placeholders.sitecore.hbs`);
                let template = getTemplate(templateFile);
                let outputDir = `${cwd}\\sitecore\\definitions\\`; 
                let outputFile = `${outputDir}placeholders.sitecore.${extension}`;  
    ...
    plop.setGenerator('component', {
        ...
        actions: [
            function customAction(answers) {
                ...
                let template = getTemplate(templateFile);
                let outputDir = `${cwd}\\sitecore\\definitions\\components\\`; 
    ...
    plop.setGenerator('template', {
        ...
        actions: [
            function customAction(answers) {
                ...
                let template = getTemplate(templateFile);
                let outputDir = `${cwd}\\sitecore\\definitions\\templates\\`; 
                let outputFile = `${outputDir}${name}.sitecore.${extension}`;   
